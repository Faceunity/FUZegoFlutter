...
public class ZegoExpressEngineMethodHandler {
    private static final String TAG = "ZegoExpressEngine";
    ...
    public static void createEngine(MethodCall call, Result result, Registrar reg, FlutterPluginBinding binding,
        ...
        ZegoExpressEngine.createEngine(appID, appSign, isTestEnv, scenario, application,
                ZegoExpressEngineEventHandler.getInstance().eventHandler);
        setPlatformLanguage();

        ZegoExpressEngine.getEngine()
                .setDataRecordEventHandler(ZegoExpressEngineEventHandler.getInstance().dataRecordEventHandler);

        createFURender(application);


        ZegoLog.log(
                "[createEngine] platform:Android, enablePlatformView:%s, sink: %d, appID:%d, appSign:%s, isTestEnv:%s, scenario:%s",
                enablePlatformView ? "true" : "false", sink != null ? sink.hashCode() : -1, appID, appSign,
                isTestEnv ? "true" : "false", scenario.name());
    ...
    public static void setEngineConfig(MethodCall call, Result result) {
        ...
        if (configMap != null && !configMap.isEmpty()) {
            ...
            result.error("setEngineConfig_null_config".toUpperCase(), "Invoke `setEngineConfig` with null config",
                    null);
        }
    }
    ...
    public static void loginRoom(MethodCall call, Result result) {
        ...
        ZegoUser user = new ZegoUser((String) (userMap != null ? userMap.get("userID") : null),
                (String) (userMap != null ? userMap.get("userName") : null));
    ...
    public static void startPublishingStream(MethodCall call, Result result) {
        ...
        ZegoPublishChannel channel =
                ZegoPublishChannel.getZegoPublishChannel(intValue((Number) call.argument("channel")));
    ...
    public static void setStreamExtraInfo(MethodCall call, final Result result) {
        ...
        ZegoExpressEngine.getEngine()
                .setStreamExtraInfo(extraInfo, channel, new IZegoPublisherSetStreamExtraInfoCallback() {
                    @Override
            ...
            if (enablePlatformView) {
                ...
                if (platformView != null) {
                    ...
                    String errorMessage = String.format(Locale.ENGLISH,
                            "The PlatformView for viewID:%d cannot be found, developer should call `createPlatformView` first and get the viewID",
                            viewID);
                ...
                // Render with Texture
                ZegoTextureRenderer textureRenderer =
                        ZegoTextureRendererController.getInstance().getTextureRenderer((long) viewID);
                ...
                if (textureRenderer != null) {
                    ...
                    String errorMessage = String.format(Locale.ENGLISH,
                            "The TextureRenderer for textureID:%d cannot be found, developer should call `createTextureRenderer` first and get the textureID",
                            viewID);
                    ZegoLog.error("[startPreview] %s", errorMessage);
    ...
    public static void stopPreview(MethodCall call, Result result) {
        ...
        if (null != sCaptureCamera) {
            sCaptureCamera.stopPreview();
        }
    ...
    public static void setVideoMirrorMode(MethodCall call, Result result) {
        ...
        ZegoVideoMirrorMode mirrorMode =
                ZegoVideoMirrorMode.getZegoVideoMirrorMode(intValue((Number) call.argument("mirrorMode")));
        ZegoPublishChannel channel =
                ZegoPublishChannel.getZegoPublishChannel(intValue((Number) call.argument("channel")));
    ...
    public static void setMinVideoBitrateForTrafficControl(MethodCall call, Result result) {
        ...
        ZegoTrafficControlMinVideoBitrateMode mode = ZegoTrafficControlMinVideoBitrateMode
                .getZegoTrafficControlMinVideoBitrateMode(intValue((Number) call.argument("mode")));
    ...
    public static void setAudioCaptureStereoMode(MethodCall call, Result result) {
        ...
        ZegoAudioCaptureStereoMode mode =
                ZegoAudioCaptureStereoMode.getZegoAudioCaptureStereoMode(intValue((Number) call.argument("mode")));
    ...
    public static void removePublishCdnUrl(MethodCall call, final Result result) {
        ...
        ZegoExpressEngine.getEngine()
                .removePublishCdnUrl(streamID, targetURL, new IZegoPublisherUpdateCdnUrlCallback() {
                    @Override
                    public void onPublisherUpdateCdnUrlResult(int errorCode) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        resultMap.put("errorCode", errorCode);
    ...
    public static void setCapturePipelineScaleMode(MethodCall call, Result result) {
        ...
        ZegoCapturePipelineScaleMode mode =
                ZegoCapturePipelineScaleMode.getZegoCapturePipelineScaleMode(intValue((Number) call.argument("mode")));
    ...
    public static void startPlayingStream(MethodCall call, Result result) {
        ...
        if (playerConfigMap != null && !playerConfigMap.isEmpty()) {
            ...
            playerConfig.videoLayer =
                    ZegoPlayerVideoLayer.getZegoPlayerVideoLayer(intValue((Number) playerConfigMap.get("videoLayer")));
    ...
    public static void startMixerTask(MethodCall call, final Result result) {
        ...
        if (inputListMap != null && !inputListMap.isEmpty()) {
            ...
            for (HashMap<String, Object> inputMap : inputListMap) {
                ...
                ZegoMixerInput inputObject = new ZegoMixerInput(streamID,
                        ZegoMixerInputContentType.getZegoMixerInputContentType(contentType), rect, soundLevelID);
    ...
    public static void enableCamera(MethodCall call, Result result) {
        ...
        if (null != sCaptureCamera) {
            sCaptureCamera.enableCamera(enable);
        }
    ...
    public static void useFrontCamera(MethodCall call, Result result) {
        ...
        if (null != sCaptureCamera) {
            sCaptureCamera.setFrontCam(enable ? 1 : 0);
    ...
    public static void sendCustomCommand(MethodCall call, final Result result) {
        ...
        ZegoExpressEngine.getEngine()
                .sendCustomCommand(roomID, command, toUserList, new IZegoIMSendCustomCommandCallback() {
                    @Override
    ...
    public static void enableCustomVideoCapture(MethodCall call, Result result) {
        ...
        ZegoExpressEngine.getEngine()
                .enableCustomVideoCapture(enable, config, ZegoPublishChannel.getZegoPublishChannel(channel));
    ...
    public static void createAudioEffectPlayer(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            audioEffectPlayer
                    .setEventHandler(ZegoExpressEngineEventHandler.getInstance().audioEffectPlayerEventHandler);
    ...
    public static void destroyAudioEffectPlayer(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("destroyAudioEffectPlayer_Can_not_find_player".toUpperCase(),
                    "Invoke `destroyAudioEffectPlayer` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerStart(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerStart_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerStart` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerStop(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerStop_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerStop` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerPause(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerPause_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerPause` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerResume(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerResume_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerResume` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerStopAll(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerStopAll_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerStopAll` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerPauseAll(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerPauseAll_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerPauseAll` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerResumeAll(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerResumeAll_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerResumeAll` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerSeekTo(MethodCall call, final Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerSeekTo_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerSeekTo` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerSetVolume(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerSetVolume_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerSetVolume` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerSetVolumeAll(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerSetVolumeAll_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerSetVolumeAll` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerGetTotalDuration(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerGetTotalDuration_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerGetTotalDuration` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerGetCurrentProgress(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerGetCurrentProgress_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerGetCurrentProgress` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerLoadResource(MethodCall call, final Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerLoadResource_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerLoadResource` but can't find specific player", null);
        }
    }
    ...
    public static void audioEffectPlayerUnloadResource(MethodCall call, Result result) {
        ...
        if (audioEffectPlayer != null) {
            ...
            result.error("audioEffectPlayerUnloadResource_Can_not_find_player".toUpperCase(),
                    "Invoke `audioEffectPlayerUnloadResource` but can't find specific player", null);
        }
    }
    ...
    public static void createTextureRenderer(MethodCall call, Result result) {
        ...
        Long textureID = ZegoTextureRendererController.getInstance()
                .createTextureRenderer(textureRegistry.createSurfaceTexture(), width, height);
    ...
    public static void updateTextureRendererSize(MethodCall call, Result result) {
        ...
        ZegoLog.log("[updateTextureRendererSize][Result] w: %d, h: %d, textureID: %d, success: %s", width, height,
                textureID, state ? "true" : "false");
