 ...
 *  
 */
public class VideoCaptureFromCamera extends IZegoCustomVideoCaptureHandler
        implements Camera.PreviewCallback, TextureView.SurfaceTextureListener, ICaptureCamera {
    ...
    private int createCamOnCameraThread() {
        ...
        for (int i = 0; i < nCnt; i++) {
            ...
            if (mCamInfo.CAMERA_FACING_FRONT == i) {
                mCam = Camera.open(i);
                break;
            }
        }
