//
//  ZegoExpressEngineMethodHandler+FaceUnity.m
//  zego_express_engine
//
//  Created by Chen on 2021/9/13.
//

#import "ZegoExpressEngineMethodHandler+FaceUnity.h"
...
@interface ZegoExpressEngineMethodHandler ()<FUModulePluginProtocol>
//缓存各个模块的实例, key为类名称
@property (nonatomic, strong) NSMutableDictionary *moduleMap;
@end

@implementation ZegoExpressEngineMethodHandler (FaceUnity)
