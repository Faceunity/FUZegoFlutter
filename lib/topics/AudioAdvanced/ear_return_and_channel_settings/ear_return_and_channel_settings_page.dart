              ...
              Row(
                children: [
                  ...
                  DropdownButton<ZegoAudioCaptureStereoMode>(items: [
                    DropdownMenuItem(
                      child: Text(ZegoAudioCaptureStereoMode.None.toString()),
                      value: ZegoAudioCaptureStereoMode.None,
                    ),
                    DropdownMenuItem(
                      child:
                          Text(ZegoAudioCaptureStereoMode.Adaptive.toString()),
                      value: ZegoAudioCaptureStereoMode.Adaptive,
                    ),
                    DropdownMenuItem(
                      child: Text(ZegoAudioCaptureStereoMode.Always.toString()),
